	...
	public static boolean checkStringForParse(String data) throws InvalidInputDataException {
		...
		for (int index = 0; index < len; index++) {
			...
			if (asc > 47 && asc < 58)
				...
				throw new InvalidInputDataException("The value must contain only numbers");
		}
...
// must contain only numbers")
	...
	public static boolean CheckNumberForGreaterOrEqualToZero(int data) throws InvalidInputDataException {
		boolean result = false;
		if (data >= 0) {
			result = true;
		} else
